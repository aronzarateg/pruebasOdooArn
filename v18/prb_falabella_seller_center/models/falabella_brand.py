...
class FalabellaBrand(models.Model):
    ...
    account_id = fields.Many2one("falabella.account", string="Cuenta Falabella", required=True, ondelete="cascade", )

    brand_id = fields.Integer(string="Brand ID", index=True, )

    name = fields.Char(string="Nombre", required=True, index=True, )
    global_identifier = fields.Char(string="Global Identifier", )

    raw_xml = fields.Text(string="XML / Respuesta original", )
